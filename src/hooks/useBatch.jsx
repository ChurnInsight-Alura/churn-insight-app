...
function transformData(data) {
  const { bucketDate, batchRunId, batchHash, stats, predictions } = data;
  ...
  const transformedData = {
    ...
    // CRÍTICO - Llamar Inmediatamente
    // Alta - Chequeo Personalizado
    // Alta - Ofrecer Incentivo
    // Media - Correo Eletrónico Automático
    // Media - Monitorear
    // Baja - Mantener Contento
    interventionPriority: [
      {
        label: "CRÍTICO - Llamar Inmediatamente",
        value: stats.QtyCritical || 0,
      },
      {
        label: "ALTA - Chequeo Personalizado",
        value: stats["QtyHigh-Personalized"] || 0,
      },
      {
        label: "ALTA - Ofrecer Incentivo",
        value: stats["QtyHigh-Incentive"] || 0,
      },
      {
        label: "MEDIA - Correo Eletrónico Automático",
        value: stats["QtyMedium-Mail"] || 0,
      },
      { label: "MEDIA - Monitorear", value: stats["QtyMedium-Monitor"] || 0 },
      { label: "BAJA - Mantener Contento", value: stats.QtyLow || 0 },
    ],
    //               CUADRADO 1
